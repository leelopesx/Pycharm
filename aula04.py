...
cursos = {"engenharia de software": ["R$2680.00" , "4 anos", 45 ],
          "engenharia da computação": ["R$2680.00", "4 anos", 35] ,
          "engenharia mecatrônica": ["R$2135.00", "5 anos", 40 ]}

    #Lower - transforma tudo em minusculo

while True:
    curso = input("Digite o curso desejado:").lower()
    if curso in cursos:
        print(f"O curso {curso} tem o valor de R$  {cursos[curso][0]}  mensal e com duração de {cursos[curso][1]}" )
    elif curso == "fim":
...
frase = "".join() #Se deixar espaço nas aspas, a string fica toda separada#Dicionario: composto por conjunto de chaves e valores
